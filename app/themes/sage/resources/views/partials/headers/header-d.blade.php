    ...
    <div class="flex flex-row flex-wrap items-center md:items-center justify-center md:justify-between">
      ...
      <nav>
        ...
        <div class="header__contact md:flex md:flex-row md:justify-end">
          @if( $phone )
          <a class="block md:inline-block my-15" href="tel:{{ preg_replace('/[^0-9]/', '', $phone) }}"><img src="/app/themes/sage/resources/assets/images/contact-icon.svg" class="inline-block pr-2"> (855) CMM-HVAC</a>
          @endif

          @if($header_booking)
          <a class="button button--secondary button--schedule">Schedule Service</a>
          @endif
        </div>
        @endif
      </nav>
...
<div class="form__toggle bg-primary-2 md:w-1/2">
  <div class="form__toggle--inner p-45 relative">
    ...
    @if( $phone )
    <a class="block md:inline-block my-15 text-white" href="tel:{{ preg_replace('/[^0-9]/', '', $phone) }}"><img src="/app/themes/sage/resources/assets/images/contact-icon.svg" class="inline-block pr-2"> (855) CMM-HVAC</a>
    @endif
    {!! $contact_hours !!}
