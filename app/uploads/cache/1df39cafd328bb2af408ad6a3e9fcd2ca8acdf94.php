<?php
  ...
  $i = 1;
?>
<section class="section section--<?php echo e($i++); ?> section--<?php echo e($section_state); ?> <?php echo e($background_state); ?> <?php echo e($background_color_state); ?> bg-center bg-cover bg-no-repeat <?php echo e($action_state); ?>" style="background-image:url(<?php echo e($bg_desktop); ?>)" data-mobile="<?php echo e($bg_mobile); ?>" data-desktop="<?php echo e($bg_desktop); ?>">
  <?php if( $content ): ?>
    <div class="container <?php echo e($text_state); ?>">
      <?php echo $content; ?>
