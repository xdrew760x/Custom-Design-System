  ...
  <div class="container">
    <p><strong><?php echo e(get_bloginfo('name', 'display')); ?></strong> ("us", "we", or "our") operates <?php echo e(preg_replace('/^https?:\/\//', '', get_bloginfo('url', 'display'))); ?> (the "Site"). This page informs you of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the Site.</p>
