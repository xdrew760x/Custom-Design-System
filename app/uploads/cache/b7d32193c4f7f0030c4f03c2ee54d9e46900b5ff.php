...
<section class="section section--<?php echo e($i); ?> section--<?php echo e($section_state); ?> <?php echo e($order_state); ?> <?php echo e($background_color_state); ?> flex">
  <div class="section__bg <?php echo e($background_state); ?> w-full md:w-/2 bg-cover bg-center" style="background-image: url(<?php echo e($bg_desktop); ?>)" data-mobile="<?php echo e($bg_mobile); ?>" data-desktop="<?php echo e($bg_desktop); ?>"></div>
  <?php if( $content ): ?>
