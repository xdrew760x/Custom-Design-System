...
$address_city = get_field('city', 'options');
$address_state = get_field('state', 'options');
$address_zipcode = get_field('zipcode', 'options');
$address_phone_number = get_field('phone_number', 'options');
$address_fax_number = get_field('fax_number', 'options');
$address_email = get_field('email', 'options');
  ...
  <div class="footer__column footer__top md:flex md:flex-row md:items-start md:justify-between">
    ...
    <div class="column">
      ...
      <p><?php echo get_bloginfo(); ?><br>
        ...
        <?php echo $address_city; ?>, <?php echo $address_state; ?> <?php echo $address_zipcode; ?></p>
        <?php endif; ?>

        <?php if($address_fax_number): ?>
        <a href="tel:<?php echo e(preg_replace('/[^0-9]/', '', $address_fax_number)); ?>" class="desk-none"><?php echo $address_fax_number; ?></a>
        <?php endif; ?>

        <?php if($address_email): ?>
        <p><a href="mailto:<?php echo e($address_email); ?>"><?php echo $address_email; ?></a></p>
        <?php endif; ?>
